...
GLOSSARY_SYNONYMS: dict[str, tuple[str, ...]] = {
    ...
    "Adjacent Change": ("Adjacent Changes",),
    "Alliance Method": ("Alliance Methods",),
    "Bob Method": ("Bob Methods",),
    "Cross Section": ("Cross Sections",),
    "Cycle of Working Bells": ("Cycles of Working Bells",),
    "Date Touch": ("Date Touches",),
    "Delight Method": ("Delight Methods",),
    "Dynamic Method": ("Dynamic Methods",),
    "Extension": ("Extensions",),
    "Extension Construction": ("Extension Constructions",),
    "Extension Path": ("Extension Paths",),
    "Fixed Place": ("Fixed Places",),
    "Half Peal": ("Half Peals",),
    "Hunter": ("Hunters",),
    "Hybrid Method": ("Hybrid Methods",),
    "Identity Change": ("Identity Changes",),
    "Jump Change": ("Jump Changes",),
    "Jump Method": ("Jump Methods",),
    "Little Method": ("Little Methods",),
    "Little Path": ("Little Paths",),
    "Long Length": ("Long Lengths",),
    "Making an Internal Place": ("Making Internal Places",),
    "Method Class": ("Method Classes",),
    "Method Name": ("Method Names",),
    "Mode": ("Modes",),
    "Parent Method": ("Parent Methods",),
    "Path": ("Paths",),
    "Peal": ("Peals",),
    "Place Method": ("Place Methods",),
    "Plain Bob Leadheads": ("Plain Bob Leadhead",),
    "Plain Method": ("Plain Methods",),
    "Quarter Peal": ("Quarter Peals", "Quarterpeal", "Quarterpeals"),
    "Related Methods": ("Related Method",),
    "Round Block": ("Round Blocks",),
    "Short Touch": ("Short Touches",),
    "Static Method": ("Static Methods",),
    "Surprise Method": ("Surprise Methods",),
    "Treble Bob Method": ("Treble Bob Methods",),
    "Treble Dodging Method": ("Treble Dodging Methods",),
    "Treble Place Method": ("Treble Place Methods",),
}
